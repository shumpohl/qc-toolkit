...
# -*- coding: utf-8 -*-
#
# qupulse documentation build configuration file, created by
...
# get version without import
with open(os.path.join('..', '..', 'qupulse', '__init__.py')) as qupulse_init:
...
exclude_patterns = ['_build', '**.ipynb_checkpoints', 'examples/9*.ipynb', 'examples/_*.ipynb']
...
html_static_path = ['_static', 'examples/img']
...
man_pages = [
    (master_doc, 'qupulse', 'qupulse Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'qupulse', 'qupulse Documentation',
   author, 'qupulse', 'One line description of project.',
   'Miscellaneous'),
]
